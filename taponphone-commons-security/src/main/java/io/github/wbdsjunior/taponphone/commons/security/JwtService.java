...
public class JwtService {
    ...
    public String generate(
        ...
        if (       null != expiresAt
            ...
            throw new IllegalArgumentException("Expires at instante must be in the future");
        }
    ...
    public String extractSubject(String token) throws InvalidKeySpecException, NoSuchAlgorithmException {
...
// openssl req -new -x509 -key rsa.pem -outform PEM -out certificate.pem
// openssl x509 -pubkey -in certificate.pem -noout -out public-key.pem
// tr -d '\n' < public-key.pem
